        ...
        <section className="px-6 py-16 flex flex-col lg:flex-row items-center gap-10">
          <div className="w-full lg:w-1/2 flex flex-col gap-6">
            ...
            <p className="text-[15px] text-text-muted leading-relaxed max-w-xl">
              Generate stunning visuals with text-to-image, image editing, video generation, and 3D model APIs. Create marketing assets, product shots, concept art, and 3D prototypes with just a text prompt — powered by the latest diffusion and transformer models.
            </p>
                      ...
                      <div className="mt-auto flex items-center justify-between border-t border-border-light pt-3">
                        <div>
                          ...
                          <div className="flex items-center gap-1 text-[11px] text-text-muted">
                            ...
                            <span className="font-medium">{getRating('image-gen', toSlug(t.title), t.rating)}</span>
                            <span>·</span>
