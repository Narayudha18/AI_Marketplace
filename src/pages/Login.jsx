      ...
      <div className="w-full max-w-sm">
        <div className="bg-surface border border-border-light rounded-xl p-6">
          <div className="flex flex-col items-center mb-6">
            ...
            <h1 className="text-lg font-bold text-text-main">{t('auth.loginTitle')}</h1>
            <p className="text-xs text-text-muted mt-0.5">{t('auth.loginDesc')}</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            ...
            <button type="submit"
              className="w-full bg-primary text-surface text-sm font-bold py-2 rounded-lg hover:opacity-90 transition-opacity">{t('auth.login')}</button>
          </form>
        </div>
