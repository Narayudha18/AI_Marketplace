      ...
      <div className="w-full max-w-md">
        <div className="bg-surface border border-border-light rounded-xl p-8">
          <div className="flex flex-col items-center mb-8">
            ...
            <p className="text-sm text-text-muted mt-1">to start using AI Agents</p>
          </div>
          ...
          <form onSubmit={handleSubmit} className="flex flex-col gap-4">
            ...
            <button type="submit"
              className="w-full bg-primary text-surface text-sm font-bold py-2.5 rounded-lg hover:opacity-90 transition-opacity mt-1">Create Account</button>
          </form>
        </div>
