  ...
  return (
    <>
      ...
      <main className="w-full max-w-[1440px] mx-auto px-6 py-16">
        <h1 className="text-[30px] md:text-[38px] font-bold leading-[1.2] tracking-tight text-text-main mb-4">Sitemap</h1>
        <p className="text-[15px] text-text-muted leading-relaxed max-w-xl mb-12">Complete index of all pages available on AI Agents Marketplace.</p>
