...
export default function AdminSidebar({ activeTab, setActiveTab, sidebarOpen, setSidebarOpen, accountOpen, setAccountOpen, currentUser, pendingSellers, allReviews, handleLogout, dark, toggle }) {
  return (
    <>
