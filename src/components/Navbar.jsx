...
export default function Navbar() {
  ...
  return (
    <>
      <div className="bg-surface text-text-main px-6 py-2.5 text-center text-xs font-semibold flex justify-center items-center gap-4 border-b border-border-light">
